...
import { ProjectBoardComponent } from '../project-board/project-board.component';
    ...
    ], // Import and add AddProjectFormComponent to imports
    ...
    loadCurrentUser() {
        ...
        console.log(
            'DashboardComponent - Current User Email:',
    ...
    loadUserName() {
        ...
        this.firebaseService
            ...
            .catch((error) => {
            console.error(
                'DashboardComponent - Error fetching user data:',
                error
            );
    ...
    loadProjects() {
        this.firebaseService.getProjectsForCurrentUser()
          .then((projects) => {
            ...
            console.log('Projects loaded in ProjectManagementComponent:', this.projects); // Optional: Log projects to console for debugging
          })
          .catch((error) => {
            console.error('Error loading projects:', error); // Optional: Log errors to console
          });
      }
